...
class App extends React.Component {
  ...
  async componentDidMount() {
    const API =
      "https://sheets.googleapis.com/v4/spreadsheets/1XcUoOxrsdH0SbB_8VKe_pJtjq3MnJHCyqcexV3j2W28/values:batchGet?ranges=categories&majorDimension=COLUMNS&key=AIzaSyAZ1DwWLQtUG4THryaQOohA1GatPSW4bKQ ";
